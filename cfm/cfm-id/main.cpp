...
void printUsage() {
    ...
    std::cout << "e.g." << std::endl << "energy0" << std::endl << "65.02 40.0" << std::endl << "86.11 60.0" << std::endl
              << "energy1" << std::endl << "65.02 100.0 ... etc" << std::endl;
    ...
    std::cout << std::endl << "ppm_mass_tol (opt):" << std::endl
              ...
              << std::endl;
    std::cout << std::endl << "abs_mass_tol (opt):" << std::endl
    ...
    std::cout << std::endl << "prob_thresh_for_prune (opt):" << std::endl
              << "The probabiltiy threshold at which to prune unlikely fragmnetations (default 0.001)" << std::endl;
