...
void FragmentTreeNode::generateChildrenOfBreak(Break &brk) {
    ...
    f0_max_e = f0_solver.runSolver(f0_output_bmax, true, f0_max_limit, MAX_BOND_CHANGE_DISTANCE);
    ...
    if (brk.getBondIdx() != -1) {
        ...
        f1_max_e = f1_solver.runSolver(f1_output_bmax, true, f1_max_limit, MAX_BOND_CHANGE_DISTANCE);
